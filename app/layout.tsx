    ...
    <html lang="en" className={`${playfair.variable} ${inter.variable}`}>
      ...
      <body className="font-sans bg-softwhite text-charcoal antialiased">
        ...
        <Script
          ...
          data-uuid="e3622af3-190e-464e-b078-6ef9e79cef2c"
        ...
        />
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-3XS5TYSM7K"
          strategy="afterInteractive"
        />
        <Script
          id="google-analytics"
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-3XS5TYSM7K');`,
          }}
        />
      </body>
    </html>
