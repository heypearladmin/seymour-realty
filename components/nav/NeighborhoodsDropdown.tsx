...
export default function NeighborhoodsDropdown() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-[380px] bg-softwhite border border-charcoal/10">
          <div className="px-8 pt-7 pb-2">
            <p className="eyebrow text-charcoal/50">Neighborhoods</p>
          </div>
          <div className="px-8 pb-7">
            ...
            <Link
              href="/neighborhoods"
              onClick={() => setOpen(false)}
              className="inline-block mt-5 text-[0.7rem] tracking-wider uppercase text-terracotta border-b border-terracotta/50 pb-0.5 hover:border-terracotta transition-colors duration-200"
            >
